...
subfamily_colours <- tibble(subfamily = c("CR1-C", "CR1-Croc", "CR1-E", "CR1-J1", "CR1-J2", "CR1-W", "CR1-X", "CR1-Y", "CR1-Z"),
                            class_colour = c("#FEFA70", "#9D9D9D", "#FED16B", "#98FF6F", "#6FFFD0", "#D363FE", "#6F87FF", "#B56FFF", "#FE6363"))
...
collated_info_2 <- collated_info %>%
  mutate(state = case_when(
    Corvus_cornix_cornix == 0 & Taeniopygia_guttata == 0 & Manacus_vitellinus == 0 & Acanthisitta_chloris == 0 ~ 0, 
    Corvus_cornix_cornix == 0 & Taeniopygia_guttata == 0 & Manacus_vitellinus == 0 & Acanthisitta_chloris == 1 ~ 1,
    Corvus_cornix_cornix == 0 & Taeniopygia_guttata == 0 & Manacus_vitellinus == 1 & Acanthisitta_chloris == 1 ~ 2, 
    Corvus_cornix_cornix == 0 & Taeniopygia_guttata == 1 & Manacus_vitellinus == 1 & Acanthisitta_chloris == 1 ~ 3, 
    Corvus_cornix_cornix == 1 & Taeniopygia_guttata == 1 & Manacus_vitellinus == 1 & Acanthisitta_chloris == 1 ~ 4,
    TRUE ~ -1 # unclear
  )
  ) %>%
