...
# set query species
species_name <- species_list$species_name[117]
...
for(i in c(1, 4, 44, 69, 91, 109, 110, 117)){
...
collated_info_2 <- collated_info %>%
  mutate(state = case_when(
    Phylloscopus_trochilus_acredula == 0 & (Taeniopygia_guttata == 0 | Sturnus_vulgaris == 0) & Corvus_brachyrhynchos == 0 & Manacus_vitellinus == 0 ~ 1, 
    Phylloscopus_trochilus_acredula == 0 & (Taeniopygia_guttata == 0 | Sturnus_vulgaris == 0) & Corvus_brachyrhynchos == 0 & Manacus_vitellinus == 1 ~ 2, 
    Phylloscopus_trochilus_acredula == 0 & (Taeniopygia_guttata == 0 | Sturnus_vulgaris == 0) & Corvus_brachyrhynchos == 1 & Manacus_vitellinus == 0 ~ 3, 
    Phylloscopus_trochilus_acredula == 0 & (Taeniopygia_guttata == 0 | Sturnus_vulgaris == 0) & Corvus_brachyrhynchos == 1 & Manacus_vitellinus == 1 ~ 4,
    Phylloscopus_trochilus_acredula == 0 & (Taeniopygia_guttata == 0 | Sturnus_vulgaris == 0) & Corvus_brachyrhynchos == 1 ~ 5,
    Phylloscopus_trochilus_acredula == 0 & (Taeniopygia_guttata == 1 | Sturnus_vulgaris == 1) & Corvus_brachyrhynchos == 0 ~ 6,
    Phylloscopus_trochilus_acredula == 0 & (Taeniopygia_guttata == 1 | Sturnus_vulgaris == 1) & Corvus_brachyrhynchos == 1 ~ 7,
    Phylloscopus_trochilus_acredula == 1 & (Taeniopygia_guttata == 1 | Sturnus_vulgaris == 1) & Corvus_brachyrhynchos == 1 ~ 8, 
    TRUE ~ -1 # unclear
  )
  ) %>%
...
divergence_plot <- ggplot(data = collated_info_2, aes(jc_dist, fill = as.factor(state))) + geom_histogram(binwidth = 0.005) +
  ...
  scale_fill_manual(labels = c("Since Acanthisitta", "Since Corvus", "Since Taeniopygia",  "Since Zosterops"),
                    values = brewer.pal(n = 4, name = 'BrBG')) +
  scale_y_continuous(limits = c(0, 60), expand = c(0,0), name = "Insertions") +
