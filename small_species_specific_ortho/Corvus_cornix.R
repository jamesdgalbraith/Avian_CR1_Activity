...
# set query species
species_name <- species_list$species_name[45]
...
collated_info_2 <- collated_info %>%
  mutate(state = case_when(
    Corvus_brachyrhynchos == 0 & Taeniopygia_guttata == 0 & Manacus_vitellinus == 0 & Acanthisitta_chloris == 0 ~ 0, 
    Corvus_brachyrhynchos == 0 & Taeniopygia_guttata == 0 & Manacus_vitellinus == 0 & Acanthisitta_chloris == 1 ~ 1,
    Corvus_brachyrhynchos == 0 & Taeniopygia_guttata == 0 & Manacus_vitellinus == 1 & Acanthisitta_chloris == 1 ~ 2, 
    Corvus_brachyrhynchos == 0 & Taeniopygia_guttata == 1 & Manacus_vitellinus == 1 & Acanthisitta_chloris == 1 ~ 3, 
    Corvus_brachyrhynchos == 1 & Taeniopygia_guttata == 1 & Manacus_vitellinus == 1 & Acanthisitta_chloris == 1 ~ 4,
    TRUE ~ -1 # unclear
  )
  ) %>%
