...
# set query species
species_name <- species_list$species_name[91]
...
for(i in c(1, 44, 69, 74, 91, 109, 110, 117)){
...
collated_info_2 <- collated_info %>%
  mutate(state = case_when(
    Zosterops_lateralis_melanops == 0 & (Taeniopygia_guttata == 0 | Sturnus_vulgaris == 0) & Corvus_brachyrhynchos == 0 & Manacus_vitellinus == 0 ~ 1, 
    Zosterops_lateralis_melanops == 0 & (Taeniopygia_guttata == 0 | Sturnus_vulgaris == 0) & Corvus_brachyrhynchos == 0 & Manacus_vitellinus == 1 ~ 2, 
    Zosterops_lateralis_melanops == 0 & (Taeniopygia_guttata == 0 | Sturnus_vulgaris == 0) & Corvus_brachyrhynchos == 1 & Manacus_vitellinus == 0 ~ 3, 
    Zosterops_lateralis_melanops == 0 & (Taeniopygia_guttata == 0 | Sturnus_vulgaris == 0) & Corvus_brachyrhynchos == 1 & Manacus_vitellinus == 1 ~ 4,
    Zosterops_lateralis_melanops == 0 & (Taeniopygia_guttata == 0 | Sturnus_vulgaris == 0) & Corvus_brachyrhynchos == 1 ~ 5,
    Zosterops_lateralis_melanops == 0 & (Taeniopygia_guttata == 1 | Sturnus_vulgaris == 1) & Corvus_brachyrhynchos == 0 ~ 6,
    Zosterops_lateralis_melanops == 0 & (Taeniopygia_guttata == 1 | Sturnus_vulgaris == 1) & Corvus_brachyrhynchos == 1 ~ 7,
    Zosterops_lateralis_melanops == 1 & (Taeniopygia_guttata == 1 | Sturnus_vulgaris == 1) & Corvus_brachyrhynchos == 1 ~ 8, 
    TRUE ~ -1 # unclear
  )
  ) %>%
