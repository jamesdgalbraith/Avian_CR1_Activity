...
# set query species
species_name <- species_list$species_name[30]
...
collated_info_2 <- collated_info %>%
  ...
  mutate(state = case_when(
    Calidris_pugnax == 0 & Scolopax_mira == 0 & Limosa_lapponica_baueri == 0 ~ 0, # 
    Calidris_pugnax == 0 & Scolopax_mira == 0 & Limosa_lapponica_baueri == 1 ~ 1, #
    Calidris_pugnax == 0 & Scolopax_mira == 1 & Limosa_lapponica_baueri == 0 ~ 2, # 
    Calidris_pugnax == 0 & Scolopax_mira == 1 & Limosa_lapponica_baueri == 1 ~ 3, # 
    Calidris_pugnax == 1 & Scolopax_mira == 1 & Limosa_lapponica_baueri == 1 ~ 4, # 
    TRUE ~ -1 # unclear
  )
  ) %>%
...
species_name <- species_list$species_name[30]
genome_name <- species_list$genome_name[30]
