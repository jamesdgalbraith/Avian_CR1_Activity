...
# set query species
species_name <- species_list$species_name[25]
...
collated_info_2 <- collated_info %>%
  mutate(state = case_when(
    Bubo_blakistoni == 0 & Strix_occidentalis == 0 & Otus_sunia == 0 & Athene_cunicularia == 0 & Tyto_alba == 0 ~ 0, #
    Bubo_blakistoni == 0 & Strix_occidentalis == 0 & Otus_sunia == 0 & Athene_cunicularia == 0 & Tyto_alba == 1 ~ 1, #
    Bubo_blakistoni == 0 & Strix_occidentalis == 0 & Otus_sunia == 0 & Athene_cunicularia == 1 & Tyto_alba == 1 ~ 2, #
    Bubo_blakistoni == 0 & Strix_occidentalis == 0 & Otus_sunia == 1 & Athene_cunicularia == 1 ~ 3, #
    Bubo_blakistoni == 0 & Strix_occidentalis == 1 & Otus_sunia == 1 ~ 4, #
    Bubo_blakistoni == 1 & Strix_occidentalis == 1 ~ 5, #
    TRUE ~ -1 # unclear
  )
  ) %>%
...
species_name <- species_list$species_name[25]
genome_name <- species_list$genome_name[25]
