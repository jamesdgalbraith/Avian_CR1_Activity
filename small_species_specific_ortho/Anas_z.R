...
# set query species
species_name <- species_list$species_name[10]
...
collated_info_2 <- collated_info %>%
  mutate(state = case_when(
    ((Anser_brachyrhynchus == 0 | Anser_indicus == 0 | Anser_cygnoides_domesticus == 0) & Anas_platyrhynchos == 0 & Gallus_gallus == 0) ~ 1,
    ((Anser_brachyrhynchus == 0 | Anser_indicus == 0 | Anser_cygnoides_domesticus == 0) & Anas_platyrhynchos == 0 & Gallus_gallus == 1) ~ 2,
    ((Anser_brachyrhynchus == 1 | Anser_indicus == 1 | Anser_cygnoides_domesticus == 1) & Anas_platyrhynchos == 0 & Gallus_gallus == 1) ~ 3,
    ((Anser_brachyrhynchus == 1 | Anser_indicus == 1 | Anser_cygnoides_domesticus == 1) & Anas_platyrhynchos == 1) ~ 4,
    TRUE ~ -1
  )
  ) %>%
...
species_name <- species_list$species_name[10]
genome_name <- species_list$genome_name[10]
