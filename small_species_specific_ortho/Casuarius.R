...
collated_info_2 <- collated_info %>%
  mutate(state = case_when(
    (Dromaius_novaehollandiae == 0 & (Apteryx_haastii == 0 | Apteryx_owenii == 0 | Apteryx_rowi == 0)) ~ 1,
    (Dromaius_novaehollandiae == 0 & (Apteryx_haastii == 1 | Apteryx_owenii == 1 | Apteryx_rowi == 1)) ~ 2,
    (Dromaius_novaehollandiae == 1 & (Apteryx_haastii == 1 | Apteryx_owenii == 1 | Apteryx_rowi == 1)) ~ 3,
    TRUE ~ -1
  )
  ) %>%
